/* 0006_desplegar-profit-overview.sql
 * ---------------------------------------------------------------------------
 * Despliega sp_get_profit_overview donde falte.
 *
 * QUE PASABA
 * ----------
 * El procedimiento esta en el arbol canonico y lo usa la pantalla de
 * Estadisticas (electron/main.js -> getProfitOverview -> pestana "Caja y
 * utilidad"), pero faltaba en las bases construidas desde el baseline
 * anterior. En esas instalaciones la pestana falla al abrirse.
 *
 * CLASIFICACION
 * -------------
 * CURRENT: tiene consumidor real en la aplicacion, no es futuro ni legado.
 * Por tanto debe existir en TODA instalacion actualizada.
 *
 * La definicion se copia tal cual de sql/procedures/reports/, sin cambiar
 * una linea de logica: esta migracion solo lo despliega.
 * ---------------------------------------------------------------------------
 */
